      ...
      <table class="table table-bordered">
        ...
        <?php foreach($product as $item): ?>
          <tr>
            ...
            <td><?= $item->type; ?></td>
            <td>
              <a href="edit.php?id=<?= $item->id ?>" class="btn btn-info">Edit</a>
      ...
      <table class="table table-bordered">
        ...
        <?php foreach($service as $item): ?>
          <tr>
            ...
            <td>
              <a href="edit.php?id=<?= $item->id ?>" class="btn btn-info">Edit</a>
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="delete.php?id=<?= $item->id ?>" class='btn btn-danger'>Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
      </table>
